...
st.title("Textured Paint Color Changer (Exact RGB Match)")
...
if uploaded_file is not None:
    ...
    lab_img = cv2.cvtColor(img_array, cv 255)    lab_img = cv2.cvtColor(img_array, cv2.COLOR_RGB2LAB).astype(np.float32)
